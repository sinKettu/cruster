...
``` shell
cargo install --git https://github.com/sinKettu/cruster --tag "v0.8.0"
```
...
``` shell
cargo install --git https://github.com/sinKettu/cruster --tag "v0.8.0" --no-default-features --features openssl-ca,crossterm
```
...
``` shell
cargo install --git https://github.com/sinKettu/cruster --tag "v0.8.0" --no-default-features --features ncurses,rcgen-ca
```
